...
public class EvaluateurNiveau {
	...
	public static int MIN_COURS=0;
	public static int MIN_EXAM=0;
	public static int MAX_COURS=25;
	public static int MAX_EXAM=75;
	
	public static int LIMITE_DC=30;
	public static int LIMITE_CB=50;
	public static int LIMITE_BA=70;
